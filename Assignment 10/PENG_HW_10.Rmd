...
$$
P \left( y_n | \mu_n  \right) = \mu_n^\left( y_n \right) \left( 1 - \mu_n \right)^ \left( 1- y_n \right)
$$
$$
\mu_n = logit^\left( -1 \right) \left( -η_n \right)
$$
...
plot(enet_varimp)
```
The XiC:x2 is the most important
